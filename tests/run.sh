...
# setenv GTEST_HOME /home/almaeder/Documents/QTSolver-dev/modules/gtest/build
# setenv LD_LIBRARY_PATH $ARPACK_DIR/lib:$LD_LIBRARY_PATH
# setenv LD_LIBRARY_PATH $CUDA_HOME/lib64:$LD_LIBRARY_PATH


setenv GTEST_HOME /home/almaeder/googletest/build

setenv LD_LIBRARY_PATH $GTEST_HOME/lib:$LD_LIBRARY_PATH
